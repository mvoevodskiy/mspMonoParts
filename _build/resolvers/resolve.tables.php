...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('mspmonoparts_core_path', null,
                    $modx->getOption('core_path') . 'components/mspmonoparts/') . 'model/';
            $modx->addPackage('mspmonoparts', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/mspmonoparts/model/schema/mspmonoparts.mysql.schema.xml';
