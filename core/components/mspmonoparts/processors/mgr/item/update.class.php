...
class mspMonoPartsItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mspmonoparts_item_err_ns');
        }
...
return 'mspMonoPartsItemUpdateProcessor';
